...
class RobotGUI:
    ...
    # ------------------------------------------------- Meal -----------------------------------------------------------------------------
        ...
        if cmd == "button1_on" and self.task_mode == "default":
            ...
            if self.chewing_start_num >= 1 and self.food_num == 1:
                print("success12")
                self.start_next("arm", "move_from_food1_to_fix_start_main")

            elif self.chewing_start_num >= 2 and self.chewing_end_num >= 1 and self.food_num == 2:
                print("success12")
                self.start_next("arm", "move_from_mouth2_to_fix_start_main")

            elif self.chewing_start_num >= 3 and self.chewing_end_num >= 2 and self.food_num == 3:
                print("success12")
                self.start_next("arm", "move_from_mouth3_to_fix_start_main")

            elif self.chewing_start_num >= 4 and self.chewing_end_num >= 3 and self.food_num == 4:
                print("success12")
                self.start_next("arm", "move_from_mouth4_to_fix_start_main")

            elif self.chewing_start_num >= 5 and self.chewing_end_num >= 4 and self.food_num == 5:
                print("success12")
                self.start_next("arm", "move_from_mouth5_to_fix_start_main")

            elif self.chewing_start_num >= 6 and self.chewing_end_num >= 5 and self.food_num == 6:
                print("success12")
            ...
            if self.chewing_end_num >= 1 and self.food_num == 2:
                # print("success12")
                self.mark_done("arm")
                self.countdown(1)
                self.start_next("arm", "move_from_food2_to_mouth_start_main")

            elif self.chewing_end_num >= 2 and self.food_num == 3:
                # print("success12")
                self.mark_done("arm")
                self.countdown(1)
                self.start_next("arm", "move_from_food3_to_mouth_start_main")

            elif self.chewing_end_num >= 3 and self.food_num == 4:
                # print("success12")
                self.mark_done("arm")
                self.countdown(1)
                self.start_next("arm", "move_from_food4_to_mouth_start_main")

            elif self.chewing_end_num >= 4 and self.food_num == 5:
                # print("success12")
                self.mark_done("arm")
                self.countdown(1)
                self.start_next("arm", "move_from_food5_to_mouth_start_main")

            elif self.chewing_end_num >= 5 and self.food_num == 6:
                # print("success12")
                self.mark_done("arm")
                self.countdown(1)
